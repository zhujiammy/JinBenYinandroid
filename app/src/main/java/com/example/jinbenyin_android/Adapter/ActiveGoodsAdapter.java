...
public class ActiveGoodsAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    public ActiveGoodsAdapter(HomeFragment fragment){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View baseView;
        baseView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.activegoods_data_xml, viewGroup, false);
