...
public class MyCouponAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    public MyCouponAdapter(MyCouponActivity activity){
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View baseView;
        baseView = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.mycoupon_data, viewGroup, false);
    ...
    public class BodyViewHolder extends RecyclerView.ViewHolder {
        ...
        private TextView Couponamount_tv,PreferentialPremises_tv,Termvalidity_tv;
        private Button Use_btn;

        public BodyViewHolder(View itemView) {
            super(itemView);

            Couponamount_tv = (TextView) itemView.findViewById(R.id.Couponamount_tv);
            PreferentialPremises_tv = (TextView) itemView.findViewById(R.id.PreferentialPremises_tv);
            Termvalidity_tv = (TextView) itemView.findViewById(R.id.Termvalidity_tv);
            Use_btn = (Button) itemView.findViewById(R.id.Use_btn);
